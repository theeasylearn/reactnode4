...
function Menu()
{
   return ( <nav className="navbar navbar-expand-xl navbar-dark bg-danger fixed-top">
...
function Courses()
{
    ...
    <SingleCourse name='React JS' photo='https://picsum.photos/200?random=1' detail='React JS course detail goes here.' />
    <SingleCourse name='Flutter' photo='https://picsum.photos/200?random=2' detail='Flutter course detail goes here.' />
    <SingleCourse name='Python' photo='https://picsum.photos/200?random=3' detail='Python course detail goes here.' />
    <SingleCourse name='PHP' photo='https://picsum.photos/200?random=4' detail='PHP course detail goes here.' />
</div>);
}
...
function Products()
{
    ...
    <div className="row">
        ...
        <div className="row">
           ...
           <SingleProduct name='School Management Software' photo='https://picsum.photos/200?random=5' />
           <SingleProduct name='Asset Management Software' photo='https://picsum.photos/200?random=6' />
